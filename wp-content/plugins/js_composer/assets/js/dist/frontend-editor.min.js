...
(window.jQuery), function($) {
        ...
        window.InlineShortcodeView_faqs =
            window.InlineShortcodeView.extend({
                render: function() {
                    var model_id = this.model.get("id");
                    return window.InlineShortcodeView_faqs.__super__.render.call(this), vc.frame_window.vc_iframe.addActivity(function() {
                        this.vc_iframe.faqs(model_id)
                    }), this
                }
            })
    } (window.jQuery), function($) {
        window.InlineShortcodeView_vc_gmaps = window.InlineShortcodeView.extend({
            render: function() {
                var model_id = this.model.get("id");
                return window.InlineShortcodeView_vc_gmaps.__super__.render.call(this), vc.frame_window.vc_iframe.addActivity(function() {
                        this.vc_iframe.vc_gmaps(model_id)
                    }),
                    this
            }
        })
            ...
            window.InlineShortcodeView_clients = window.InlineShortcodeView.extend({
                render: function() {
                    var model_id = this.model.get("id");
                    return window.InlineShortcodeView_clients.__super__.render.call(this), vc.frame_window.vc_iframe.addActivity(function() {
                        this.vc_iframe.clients(model_id)
                    }), this
                }
            })
    } (window.jQuery), function($) {
        window.InlineShortcodeView_testimonials = window.InlineShortcodeView.extend({
            render: function() {
                var model_id = this.model.get("id");
                return window.InlineShortcodeView_testimonials.__super__.render.call(this), vc.frame_window.vc_iframe.addActivity(function() {
                        this.vc_iframe.testimonials(model_id)
                    }),
                    this
            }
        })
