    ...
    vc_iframe.showNoContent = function(show) {
        ...
        window.vc_pieChart(), window.setTimeout(function() {
            ...
            var $el = $("[data-model-id=" +
                model_id + "]");
            imgHoverlay()
        }, vc_iframe.faqs = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            faqItemsFilter();
            $(".togglec").hide();
            $(".togglec.open").show();
            $el.find(".togglet").unbind("click").click(function(e) {
                var $this = $(this);
                if ($this.hasClass("toggleta")) $this.removeClass("toggleta").next().slideUp(500);
                else $this.addClass("toggleta").next().slideDown(500)
            })
        }, vc_iframe.vc_gmaps = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            jQuery(".googlemaps").each(function() {
                jQuery(this).google_maps()
            })
        },
        vc_iframe.clients = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            $(".clients_wrapper").each(function() {
                jQuery(this).clients_carousel()
            })
        }, vc_iframe.testimonials = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
